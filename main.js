...
const mqpc = window.matchMedia("(min-width: 700px)");
...
const mqd = window.matchMedia("(max-width: 480px)");
// helloPage.addEventListener("scroll", swipe1);
// helloPage.addEventListener("drag", swipe1);
